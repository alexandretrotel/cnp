...
///
/// # Arguments
/// * `dir_path` - A string slice representing the path to the directory to check.
///
/// # Returns
///
...
/// }
/// ```
pub fn is_typescript_project(dir_path: &str) -> bool {
    Path::new(&dir_path).join("tsconfig.json").exists()
}
